...
MODEL_NAME="2026_0720_all_points_rel_stage1"
...
REPO_NAME="G1_real_6D_window_cont_rel_0526-0601_all_points_rel"
REPO_NAME2="pick_cube_bottle_g1_0616_0617_0623_0624_0625_0626_all_points_rel"
REPO_NAME3="pick_cube_bottle_g1_0626_0629_all_points_rel"
...
#     --dataset-path-groups "${DATASET_PATH2},${DATASET_PATH3}" "${DATASET_PATH}" \
#     --dataset_embodiment_tags "${EMBODIMENT_TAG2}" "${EMBODIMENT_TAG}" \
#     --dataset_mix_ratios "2" "1" \
#     --num_gpus "${NUM_GPUS}" \
