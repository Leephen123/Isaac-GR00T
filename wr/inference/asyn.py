...
class ClientConfig:
    ...
    api_token: str = None
    mocap_data_path: Path = Path("/home/unitree/mpz/0604/wr_new/data/data.json") #/home/unitree/wr/standalized_data/housework_0.npy
    infer_fps: float = 100.0
    send_fps: float = 70 # 70.0
...
def action_to_abs_pose7(action, root_rel_cum, root_pose_init, config: ClientConfig):
    ...
    return action_concat_abs, next_root_rel_cum
...
def build_observation_with_history(
    ...
    observation = build_observation_from_msgv2_mpz_normal(
        msg,
...
def main():
    ...
    def infer_once(policy_client, msg, frame, root_rel_cum_snapshot, debug):
        ...
        while True:
            ...
            if prefetched_result is not None:
                ...
                if action_concat_abs is None:
                    ...
                    action_concat_abs, root_rel_cum = infer_once(
