    ...
    def _create_dataset(self, save_cfg_dir: Path):
        ...
        if self.config.training.start_from_checkpoint is not None:
            processor = AutoProcessor.from_pretrained(
                ...
                head_camera_degradation=self.model_config.head_camera_degradation,
                head_camera_degradation_prob=self.model_config.head_camera_degradation_prob,
                model_name=self.model_config.model_name,
                ...
                state_noise=self.model_config.state_noise,
                ...
                history_shift=self.model_config.history_shift,
